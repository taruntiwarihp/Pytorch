...
from datasets.celebrity import CelebImageFolder, build_transform
...
def parse_args():
    ...
    parser.add_argument('--dataDir',
                        help='data directory',
                        type=str,
                        default='data/celeb_classification')
...
def main():
    ...
    data = CelebImageFolder(opts.dataDir, sampling=1, transform=trans)
