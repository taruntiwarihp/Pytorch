...
def parse_args():
    ...
    parser.add_argument('--model_type',
                        ...
                        choices=['base', 'wide_res', 'mobile_net', 'xception', 'vgg', 'densenet', 'squeezenet','efficientnet_b4'])
...
def main():
    ...
    # Preparing Dataset
    data = HairDataset(opts.dataDir, get_transform(train=True, opts=opts))
    data_test = HairDataset(opts.dataDir, get_transform(train=False, opts = opts))
    ...
    train_loader = DataLoader(trainset, batch_size=16, shuffle=True, pin_memory=True, num_workers=4)
    val_loader = DataLoader(valset, batch_size=16, shuffle=True, pin_memory=True, drop_last=True, num_workers=4)
