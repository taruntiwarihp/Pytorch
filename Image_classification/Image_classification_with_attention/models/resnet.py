...
def build_resnet50(pretrained, **kwargs):

    model = ResNet(Bottleneck, [3, 4, 6, 3], **kwargs)

    if pretrained:
        ckpt = torch.load('pretrained_weights/resnet50-0676ba61.pth')

        model.load_state_dict(ckpt)

    return model

def build_wrs50(pretrained, **kwargs):
    ...
    if pretrained:
        ckpt = torch.load('pretrained_weights/wide_resnet50_2-95faca4d.pth')
