...
def build_efficientnet_model(model_name, pretrained=True, num_classes=1000):
    if pretrained and model_name in url_map.keys():
        model = EfficientNet.from_pretrained(model_name=model_name,advprop=False, num_classes=num_classes, in_channels=3)
